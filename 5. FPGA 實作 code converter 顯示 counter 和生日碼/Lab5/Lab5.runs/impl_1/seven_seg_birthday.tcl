...
set rc [catch {
  ...
  add_files -quiet D:/DDLAB/DDLab5/Lab5/Lab5.runs/synth_1/seven_seg_birthday.dcp
...
set rc [catch {
  ...
  create_report "impl_1_place_report_control_sets_0" "report_control_sets -file seven_seg_birthday_control_sets_placed.rpt"
...
set rc [catch {
  ...
  create_report "impl_1_route_report_timing_summary_0" "report_timing_summary -file seven_seg_birthday_timing_summary_routed.rpt -warn_on_violation  -rpx seven_seg_birthday_timing_summary_routed.rpx"
